...
describe('The list updaters', () => {
  test('update the suggestions list', () => {
    ...
    expect(suggestionsNode.firstChild.firstChild.href).toBe('/arguments?conclusion=socrates%20is%20a%20man');
    expect(suggestionsNode.lastChild.firstChild.innerHTML).toBe(second);
    expect(suggestionsNode.lastChild.firstChild.href).toBe('/arguments?conclusion=socrates%20is%20mortal');
  });
});
